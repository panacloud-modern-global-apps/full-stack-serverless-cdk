...
export declare class BootstrapStack {
    ...
    protected constructor(sdkProvider: SdkProvider, sdk: ISDK, resolvedEnvironment: cxapi.Environment, toolkitStackName: string, currentToolkitInfo?: ToolkitInfo | undefined);
