...
var AmplifyTOTPSetup = /** @class */ (function () {
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("amplify-form-section", { headerText: I18n.get(this.headerText), submitButtonText: I18n.get(Translations.TOTP_SUBMIT_BUTTON_TEXT), handleSubmit: function (event) { return _this.verifyTotpToken(event); }, loading: this.loading }, h("div", { class: "totp-setup" }, h("img", { src: this.qrCodeImageSource, alt: I18n.get(Translations.QR_CODE_ALT) }), h("amplify-form-field", { label: I18n.get(Translations.TOTP_LABEL), inputProps: this.inputProps, fieldId: "totpCode", name: "totpCode", handleInputChange: function (event) { return _this.handleTotpInputChange(event); } })))));
    };
    return class_1;
}());
