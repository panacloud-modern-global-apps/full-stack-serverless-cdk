...
var componentFieldMapping = {
  username: function username(ff) {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-username-field", {
      label: ff.label,
  ...
  password: function password(ff) {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-password-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      hint: ff.hint,
      required: ff.required,
  ...
  email: function email(ff) {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-email-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      required: ff.required,
      handleInputChange: ff.handleInputChange,
  ...
  code: function code(ff) {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-code-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      hint: ff.hint,
      required: ff.required,
  ...
  phone_number: function phone_number(ff) {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-phone-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      required: ff.required,
      handleInputChange: ff.handleInputChange,
  ...
  "default": function _default(ff) {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", {
      label: ff.label,
      placeholder: ff.placeholder,
      required: ff.required,
      handleInputChange: ff.handleInputChange,
...
function () {
  function AmplifyCodeField(hostRef) {
    ...
    this.label = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].CODE_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].CODE_PLACEHOLDER;
...
function () {
  ...
  AmplifyCountryDialCode.prototype.render = function () {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-select", {
      fieldId: this.fieldId,
...
function () {
  function AmplifyEmailField(hostRef) {
    ...
    this.label = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMAIL_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMAIL_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  ...
  AmplifyFormSection.prototype.render = function () {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("form", {
      onSubmit: this.handleSubmit
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-section", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
      name: "amplify-form-section-header"
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      "class": "form-section-header"
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("h3", {
      "class": "header",
      "data-test": this.testDataPrefix + '-header-section'
    }, this.headerText), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      "class": "subtitle"
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
      name: "subtitle"
    }))))), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", {
      name: "amplify-form-section-footer"
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      "class": "form-section-footer"
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", {
      type: "submit",
      "data-test": this.testDataPrefix + '-' + this.testDataPrefix + '-button'
    }, this.loading ? Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-loading-spinner", null) : Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, this.submitButtonText)), this.secondaryFooterContent)))));
  };
...
function () {
  function AmplifyPasswordField(hostRef) {
    ...
    this.label = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].PASSWORD_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].PASSWORD_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
...
function () {
  function AmplifyPhoneField(hostRef) {
    ...
    this.label = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHONE_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].PHONE_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
  ...
  AmplifyPhoneField.prototype.render = function () {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-field", {
      label: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.label),
      hint: this.hint,
      required: this.required
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
      "class": "phone-field",
      slot: "input"
    }, Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-country-dial-code", {
      dialCode: this.dialCode,
      handleInputChange: this.handleInputChange
    }), Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-input", {
      fieldId: this.fieldId,
      type: "tel",
      handleInputChange: this.handleInputChange,
      placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.placeholder),
...
function () {
  ...
  AmplifySelect.prototype.contructSelectOptions = function (opts) {
    ...
    opts.forEach(function (opt) {
      content.push(Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("option", {
        value: opt.value,
  ...
  AmplifySelect.prototype.render = function () {
    return Object(_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__["h"])("select", {
      name: this.fieldId,
      id: this.fieldId,
      "class": "select",
...
function () {
  function AmplifyUsernameField(hostRef) {
    ...
    this.label = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].USERNAME_LABEL;
    /** Used for the placeholder label */

    this.placeholder = _Translations_392acb9b_js__WEBPACK_IMPORTED_MODULE_3__["T"].USERNAME_PLACEHOLDER;
    /** The required flag in order to make an input required prior to submitting a form */
