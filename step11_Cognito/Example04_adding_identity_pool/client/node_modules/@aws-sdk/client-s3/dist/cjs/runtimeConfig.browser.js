...
exports.ClientDefaultValues = {
    ...
    credentialDefaultProvider: invalid_dependency_1.invalidFunction("Credential is missing"),
    defaultUserAgent: util_user_agent_browser_1.defaultUserAgent(package_json_1.default.name, package_json_1.default.version),
    ...
    md5: md5_js_1.Md5,
    region: invalid_dependency_1.invalidFunction("Region is missing"),
