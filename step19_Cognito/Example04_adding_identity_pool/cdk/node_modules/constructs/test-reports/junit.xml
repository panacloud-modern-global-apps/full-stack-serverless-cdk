...
<testsuites name="jest tests" tests="44" failures="0" errors="0" time="3.885">
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-12-14T05:35:36" time="3.057" tests="43">
    ...
    <testcase classname=" constructs cannot be created with an empty name unless they are root" name=" constructs cannot be created with an empty name unless they are root" time="0.035">
    </testcase>
    ...
    <testcase classname=" cannot calculate uniqueId if the construct path is [&quot;Default&quot;]" name=" cannot calculate uniqueId if the construct path is [&quot;Default&quot;]" time="0.014">
    </testcase>
    ...
    <testcase classname=" construct.setContext(k,v) sets context at some level and construct.getContext(key) will return the lowermost value defined in the stack" name=" construct.setContext(k,v) sets context at some level and construct.getContext(key) will return the lowermost value defined in the stack" time="0">
    </testcase>
    ...
    <testcase classname=" addWarning(message) can be used to add a &quot;WARNING&quot; message entry to the construct" name=" addWarning(message) can be used to add a &quot;WARNING&quot; message entry to the construct" time="0">
    </testcase>
    ...
    <testcase classname=" node.validate() returns an empty array if the construct does not implement IValidation" name=" node.validate() returns an empty array if the construct does not implement IValidation" time="0">
    </testcase>
    ...
    <testcase classname=" both &quot;onValidate()&quot; and &quot;addValidation()&quot; works" name=" both &quot;onValidate()&quot; and &quot;addValidation()&quot; works" time="0.001">
    </testcase>
    <testcase classname=" construct.lock() protects against adding children anywhere under this construct (direct or indirect)" name=" construct.lock() protects against adding children anywhere under this construct (direct or indirect)" time="0.001">
    </testcase>
    ...
    <testcase classname="defaultChild can override defaultChild" name="defaultChild can override defaultChild" time="0.001">
    </testcase>
    ...
    <testcase classname="defaultChild fails if there are both &quot;Resource&quot; and &quot;Default&quot;" name="defaultChild fails if there are both &quot;Resource&quot; and &quot;Default&quot;" time="0">
    </testcase>
  ...
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-12-14T05:35:39" time="0.146" tests="1">
