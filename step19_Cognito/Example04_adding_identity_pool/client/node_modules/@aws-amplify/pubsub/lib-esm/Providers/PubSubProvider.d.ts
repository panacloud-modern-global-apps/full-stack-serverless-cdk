...
export declare abstract class AbstractPubSubProvider implements PubSubProvider {
    ...
    abstract publish(topics: string[] | string, msg: any, options?: ProvidertOptions): void;
    abstract subscribe(topics: string[] | string, options?: ProvidertOptions): Observable<any>;
}
