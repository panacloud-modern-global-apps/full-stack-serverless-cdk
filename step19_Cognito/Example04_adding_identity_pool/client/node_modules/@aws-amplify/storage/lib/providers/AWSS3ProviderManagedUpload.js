            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!core_1.Platform.isReactNative) return [3 /*break*/, 3];
                        return [4 /*yield*/, fetch_http_handler_1.streamCollector(body)];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        client = new client_s3_1.S3Client(__assign(__assign({ region: region,
                            credentials: credentials }, localTestingConfig), { requestHandler: new axios_http_handler_1.AxiosHttpHandler({}, emitter), customUserAgent: core_1.getAmplifyUserAgent(), urlParser: url_parser_node_1.parseUrl }));
