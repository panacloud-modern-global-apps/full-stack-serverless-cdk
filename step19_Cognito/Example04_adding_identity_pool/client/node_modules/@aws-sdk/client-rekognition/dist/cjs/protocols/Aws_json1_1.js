...
exports.serializeAws_json1_1DetectProtectiveEquipmentCommand = async (input, context) => {
    const headers = {
        "Content-Type": "application/x-amz-json-1.1",
...
exports.deserializeAws_json1_1DetectProtectiveEquipmentCommand = async (output, context) => {
    if (output.statusCode >= 300) {
...
const deserializeAws_json1_1BodyParts = (output, context) => {
    return (output || []).map((entry) => deserializeAws_json1_1ProtectiveEquipmentBodyPart(entry, context));
};
...
const deserializeAws_json1_1EquipmentDetections = (output, context) => {
    return (output || []).map((entry) => deserializeAws_json1_1EquipmentDetection(entry, context));
};
...
const deserializeAws_json1_1ProtectiveEquipmentPersons = (output, context) => {
    return (output || []).map((entry) => deserializeAws_json1_1ProtectiveEquipmentPerson(entry, context));
};
